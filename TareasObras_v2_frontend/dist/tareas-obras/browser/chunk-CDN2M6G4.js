import{Ca as q,Da as g,Fa as A,Ha as P,j as Q,l as E,n as N,q as O}from"./chunk-WGUKE3IX.js";import{Db as z,Ja as b,K as v,Ka as C,L as h,Na as $,Pa as r,Q as T,Wa as i,Xb as B,Z as p,Za as k,_a as I,db as u,eb as d,fb as x,gb as M,hb as w,ob as l,pb as D,qb as F,rb as f,tb as m,ub as y,wb as j,xb as S,ya as o}from"./chunk-BZGD74QT.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
