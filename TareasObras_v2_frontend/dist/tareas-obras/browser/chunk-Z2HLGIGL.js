import{a as Y}from"./chunk-IZ54DP6E.js";import{a as te,b as ae}from"./chunk-XSACVJZW.js";import{a as X}from"./chunk-W5OO23I3.js";import"./chunk-HWJEREV2.js";import{h as ee}from"./chunk-OS4IJJGC.js";import{d as J,f as K,g as Q}from"./chunk-RCV2F5U3.js";import{Da as y,Fa as W,Ha as Z,j as q,l as G,q as _}from"./chunk-WGUKE3IX.js";import{$a as b,Db as U,Eb as H,Ja as h,K as T,Ka as F,L as z,Na as L,Pa as u,Pb as I,Q as v,Va as S,W as $,Wa as p,X as M,Ya as B,Z as k,Za as x,_a as d,bb as N,cb as P,da as A,db as r,eb as l,fb as c,ja as j,jb as O,nb as g,ob as s,pb as R,qb as V,va as D,vb as w,wb as m,xb as f,ya as o}from"./chunk-BZGD74QT.js";import"./chunk-7CGTOI24.js";var le=["*"];function se(e,n){if(e&1&&(r(0,"span",3),m(1),l()),e&2){let t=s();o(),f(t.label)}}function ce(e,n){if(e&1&&c(0,"span",5),e&2){let t=s(2);d(t.icon),p("ngClass","p-avatar-icon")}}function pe(e,n){if(e&1&&u(0,ce,1,3,"span",4),e&2){let t=s(),a=w(5);p("ngIf",t.icon)("ngIfElse",a)}}function me(e,n){if(e&1){let t=O();r(0,"img",7),g("error",function(i){$(t);let C=s(2);return M(C.imageError(i))}),l()}if(e&2){let t=s(2);p("src",t.image,D),S("aria-label",t.ariaLabel)}}function ue(e,n){if(e&1&&u(0,me,1,2,"img",6),e&2){let t=s();p("ngIf",t.image)}}var de=({dt:e})=>`
.p-avatar {
    display: inline-flex;
    align-items: center;
