import{Da as q,Ea as g,Ga as A,Ja as P,j as Q,l as E,n as N,q as O}from"./chunk-QULKBJWY.js";import{Bb as j,Cb as S,Ib as z,K as v,Ka as b,L as h,La as C,Oa as $,Q as T,Qa as r,Z as p,_a as i,ac as B,bb as k,cb as I,hb as u,ib as d,jb as x,kb as M,lb as w,tb as l,ub as D,vb as F,wb as f,yb as m,za as o,zb as y}from"./chunk-GAGSHXP2.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
