import{a as Y}from"./chunk-XML2CNGD.js";import{a as te,b as ae}from"./chunk-MJS6U6Y6.js";import{a as X}from"./chunk-2FRCMXD3.js";import"./chunk-HWJEREV2.js";import{h as ee}from"./chunk-BOEGSUYG.js";import{d as J,f as K,g as Q}from"./chunk-K2WCN3DC.js";import{Ba as W,Da as Z,g as q,i as G,n as _,za as y}from"./chunk-X4XCHPV4.js";import{Cb as U,Db as H,Ia as h,Ja as F,K as T,L as z,Ma as L,Oa as u,Ob as I,Q as v,Ua as w,Va as p,W as $,X as M,Xa as B,Ya as x,Z as k,Za as f,_a as b,ab as N,bb as O,cb as r,da as j,db as l,eb as c,ib as P,ja as A,mb as g,nb as s,ob as R,pb as V,ua as D,ub as S,vb as m,wb as d,xa as o}from"./chunk-INRNEGWD.js";import"./chunk-7CGTOI24.js";var le=["*"];function se(e,n){if(e&1&&(r(0,"span",3),m(1),l()),e&2){let t=s();o(),d(t.label)}}function ce(e,n){if(e&1&&c(0,"span",5),e&2){let t=s(2);f(t.icon),p("ngClass","p-avatar-icon")}}function pe(e,n){if(e&1&&u(0,ce,1,3,"span",4),e&2){let t=s(),a=S(5);p("ngIf",t.icon)("ngIfElse",a)}}function me(e,n){if(e&1){let t=P();r(0,"img",7),g("error",function(i){$(t);let C=s(2);return M(C.imageError(i))}),l()}if(e&2){let t=s(2);p("src",t.image,D),w("aria-label",t.ariaLabel)}}function ue(e,n){if(e&1&&u(0,me,1,2,"img",6),e&2){let t=s();p("ngIf",t.image)}}var fe=({dt:e})=>`
.p-avatar {
    display: inline-flex;
    align-items: center;
