import{Ba as A,Da as P,g as Q,i as E,k as N,n as O,ya as q,za as g}from"./chunk-X4XCHPV4.js";import{Cb as z,Ia as b,Ja as C,K as v,L as h,Ma as $,Oa as r,Q as T,Va as i,Wb as B,Ya as k,Z as p,Za as I,cb as u,db as d,eb as x,fb as M,gb as w,nb as l,ob as D,pb as F,qb as f,sb as m,tb as y,vb as j,wb as S,xa as o}from"./chunk-INRNEGWD.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
